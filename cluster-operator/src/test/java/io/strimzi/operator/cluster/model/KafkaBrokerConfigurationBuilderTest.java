...
import io.strimzi.api.kafka.model.KafkaAuthorizationRunAsBuilder;
...
public class KafkaBrokerConfigurationBuilderTest {
    ...
    @Test
    public void testRunAsAuthorization() {

        KafkaAuthorization auth = new KafkaAuthorizationRunAsBuilder()
            .addToSuperUsers("testuser", "CN=testuser")
            .build();
        ...
        assertThat(configuration, isEquivalent("authorizer.class.name=com.ibm.eventstreams.runas.authorizer.RunAsAuthorizer\n" +
            "principal.builder.class=com.ibm.eventstreams.runas.authenticate.RunAsPrincipalBuilder\n" +
            "super.users=User:CN=my-cluster-kafka,O=io.strimzi;User:CN=my-cluster-entity-operator,O=io.strimzi;User:CN=my-cluster-kafka-exporter,O=io.strimzi;User:testuser;User:CN=testuser"));
    }
    ...
    public void testWithNoListeners()  {
        ...
        assertThat(configuration, isEquivalent("listener.name.replication-9091.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                ...
                "listener.name.runas-8091.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                "listener.name.runas-8091.ssl.keystore.password=${CERTS_STORE_PASSWORD}",
                "listener.name.runas-8091.ssl.keystore.type=PKCS12",
                "listener.name.runas-8091.ssl.truststore.location=/tmp/kafka/cluster.truststore.p12",
                "listener.name.runas-8091.ssl.truststore.password=${CERTS_STORE_PASSWORD}",
                "listener.name.runas-8091.ssl.truststore.type=PKCS12",
                "listener.name.runas-8091.ssl.client.auth=required",
                "listener.name.runas-8091.runas.sasl.jaas.config=com.ibm.eventstreams.runas.authenticate.RunAsLoginModule required;",
                "listener.name.runas-8091.scram-sha-512.sasl.jaas.config=org.apache.kafka.common.security.scram.ScramLoginModule required;",
                "listener.name.runas-8091.sasl.enabled.mechanisms=RUNAS,SCRAM-SHA-512",
                "listeners=RUNAS-8091://0.0.0.0:8091,REPLICATION-9091://0.0.0.0:9091",
                "advertised.listeners=RUNAS-8091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:8091,REPLICATION-9091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9091",
                "listener.security.protocol.map=RUNAS-8091:SASL_SSL,REPLICATION-9091:SSL",
    ...
    public void testWithPlainListenersWithoutAuth()  {
        ...
        assertThat(configuration, isEquivalent("listener.name.replication-9091.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                ...
                "listener.name.runas-8091.scram-sha-512.sasl.jaas.config=org.apache.kafka.common.security.scram.ScramLoginModule required;",
                "listener.name.runas-8091.sasl.enabled.mechanisms=RUNAS,SCRAM-SHA-512",
                "listeners=RUNAS-8091://0.0.0.0:8091,REPLICATION-9091://0.0.0.0:9091,PLAIN-9092://0.0.0.0:9092",
                "advertised.listeners=RUNAS-8091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:8091,REPLICATION-9091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9091,PLAIN-9092://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9092",
                "listener.security.protocol.map=RUNAS-8091:SASL_SSL,REPLICATION-9091:SSL,PLAIN-9092:PLAINTEXT",
                "inter.broker.listener.name=REPLICATION-9091",
                "sasl.enabled.mechanisms=",
                "ssl.secure.random.implementation=SHA1PRNG",
                "ssl.endpoint.identification.algorithm=HTTPS"));
    ...
    public void testWithPlainListenersWithSaslAuth()  {
        ...
        assertThat(configuration, isEquivalent("listener.name.replication-9091.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                ...
                "listeners=RUNAS-8091://0.0.0.0:8091,REPLICATION-9091://0.0.0.0:9091,PLAIN-9092://0.0.0.0:9092",
                "advertised.listeners=RUNAS-8091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:8091,REPLICATION-9091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9091,PLAIN-9092://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9092",
                "listener.security.protocol.map=RUNAS-8091:SASL_SSL,REPLICATION-9091:SSL,PLAIN-9092:SASL_PLAINTEXT",
                "inter.broker.listener.name=REPLICATION-9091",
                "sasl.enabled.mechanisms=",
                "ssl.secure.random.implementation=SHA1PRNG",
                "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testWithTlsListenersWithoutAuth()  {
        ...
        assertThat(configuration, isEquivalent("listener.name.replication-9091.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                ...
                "listener.name.runas-8091.scram-sha-512.sasl.jaas.config=org.apache.kafka.common.security.scram.ScramLoginModule required;",
                "listener.name.runas-8091.sasl.enabled.mechanisms=RUNAS,SCRAM-SHA-512",
                "listeners=RUNAS-8091://0.0.0.0:8091,REPLICATION-9091://0.0.0.0:9091,TLS-9093://0.0.0.0:9093",
                "advertised.listeners=RUNAS-8091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:8091,REPLICATION-9091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9091,TLS-9093://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9093",
                "listener.security.protocol.map=RUNAS-8091:SASL_SSL,REPLICATION-9091:SSL,TLS-9093:SSL",
                "inter.broker.listener.name=REPLICATION-9091",
                "sasl.enabled.mechanisms=",
                "ssl.secure.random.implementation=SHA1PRNG",
                "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testWithExternalRouteListenersWithoutAuth()  {
        ...
        assertThat(configuration, isEquivalent("listener.name.replication-9091.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                ...
                "listener.name.runas-8091.scram-sha-512.sasl.jaas.config=org.apache.kafka.common.security.scram.ScramLoginModule required;",
                "listener.name.runas-8091.sasl.enabled.mechanisms=RUNAS,SCRAM-SHA-512",
                "listeners=RUNAS-8091://0.0.0.0:8091,REPLICATION-9091://0.0.0.0:9091,EXTERNAL-9094://0.0.0.0:9094",
                "advertised.listeners=RUNAS-8091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:8091,REPLICATION-9091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9091,EXTERNAL-9094://${STRIMZI_EXTERNAL_9094_ADVERTISED_HOSTNAME}:${STRIMZI_EXTERNAL_9094_ADVERTISED_PORT}",
                "listener.security.protocol.map=RUNAS-8091:SASL_SSL,REPLICATION-9091:SSL,EXTERNAL-9094:SSL",
                "inter.broker.listener.name=REPLICATION-9091",
                "sasl.enabled.mechanisms=",
                "ssl.secure.random.implementation=SHA1PRNG",
                "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testWithExternalRouteListenersWithSaslAuth()  {
        ...
        assertThat(configuration, isEquivalent("listener.name.replication-9091.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                ...
                "listeners=RUNAS-8091://0.0.0.0:8091,REPLICATION-9091://0.0.0.0:9091,EXTERNAL-9094://0.0.0.0:9094",
                "advertised.listeners=RUNAS-8091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:8091,REPLICATION-9091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9091,EXTERNAL-9094://${STRIMZI_EXTERNAL_9094_ADVERTISED_HOSTNAME}:${STRIMZI_EXTERNAL_9094_ADVERTISED_PORT}",
                "listener.security.protocol.map=RUNAS-8091:SASL_SSL,REPLICATION-9091:SSL,EXTERNAL-9094:SASL_SSL",
                "inter.broker.listener.name=REPLICATION-9091",
                "sasl.enabled.mechanisms=",
                "ssl.secure.random.implementation=SHA1PRNG",
                "ssl.endpoint.identification.algorithm=HTTPS",
    ...
    public void testWithExternalListenersLoadBalancerWithoutTls()  {
        ...
        assertThat(configuration, isEquivalent("listener.name.replication-9091.ssl.keystore.location=/tmp/kafka/cluster.keystore.p12",
                ...
                "listeners=RUNAS-8091://0.0.0.0:8091,REPLICATION-9091://0.0.0.0:9091,EXTERNAL-9094://0.0.0.0:9094",
                "advertised.listeners=RUNAS-8091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:8091,REPLICATION-9091://my-cluster-kafka-${STRIMZI_BROKER_ID}.my-cluster-kafka-brokers.my-namespace.svc:9091,EXTERNAL-9094://${STRIMZI_EXTERNAL_9094_ADVERTISED_HOSTNAME}:${STRIMZI_EXTERNAL_9094_ADVERTISED_PORT}",
                "listener.security.protocol.map=RUNAS-8091:SASL_SSL,REPLICATION-9091:SSL,EXTERNAL-9094:PLAINTEXT",
                "inter.broker.listener.name=REPLICATION-9091",
                "sasl.enabled.mechanisms=",
                "ssl.secure.random.implementation=SHA1PRNG",
                "ssl.endpoint.identification.algorithm=HTTPS"));
